...
//        echo $idCmd;
        ...
        return view('dashboard.espace-client.sauvegarder-panier')->with($data);
    }
    ...
    public function show() {
        ...
        return view('dashboard.espace-client.mes-commandes');
    }
    ...
    public function showCommande($commandeID) {
        ...
        return view('dashboard.espace-client.visualiser-commande')->with('commandeID', $commandeID);
    }
    ...
    public function modify($commandeID) {
        return view('dashboard.espace-client.modifier-ma-commande')->with('commandeID', $commandeID);
    }
