...
jQuery(document).ready(function ($) {
    ...
    //responsive code end
        ...
        <div id="slider2_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 400px; overflow: hidden; ">
            ...
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 400px; overflow: hidden;">
                ...
                <?php
                $row = 1;
                if (($handle = fopen(public_path() . "/img/photos-videos/list.csv", "r")) !== FALSE) {
                    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                        $num = count($data);
                        if ($num == 3) {
                            echo
                            '<div>'
                            . '<img u="image" src="' . $data[0] . '" alt="' . $data[2] . '" />'
                            . '<img u="thumb" src="' . $data[1] . '" alt="' . $data[2] . '" />'
                            . '</div>';
                        }
                    }
                    fclose($handle);
            ...
            <style>
                .jssora02l,.jssora02r,.jssora02ldn,.jssora02rdn{position:absolute;cursor:pointer;display:block;background:no-repeat;overflow:hidden}.jssora02l{background-position:-3px -33px}.jssora02r{background-position:-63px -33px}.jssora02l:hover{background-position:-123px -33px}.jssora02r:hover{background-position:-183px -33px}.jssora02ldn{background-position:-243px -33px}.jssora02rdn{background-position:-303px -33px}
            </style>
            <!-- Arrow Left -->
